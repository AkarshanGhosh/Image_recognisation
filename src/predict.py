...
class PredictionApp:
    ...
    def show_final_stats(self):
        ...
        tk.Label(header_frame, text="Class", width=10, font=("Arial", 11, "bold"), bg="#e0e0e0").pack(side=tk.LEFT, padx=5, pady=5)
        tk.Label(header_frame, text="Predictions", width=10, font=("Arial", 11, "bold"), bg="#e0e0e0").pack(side=tk.LEFT, padx=5, pady=5)
        tk.Label(header_frame, text="Correct", width=10, font=("Arial", 11, "bold"), bg="#e0e0e0").pack(side=tk.LEFT, padx=5, pady=5)
        tk.Label(header_frame, text="Accuracy", width=10, font=("Arial", 11, "bold"), bg="#e0e0e0").pack(side=tk.LEFT, padx=5, pady=5)
